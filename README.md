...
Wersjonowana migawka po pozytywnej bramce powstaje w `release/v0.1/`; sposób jej budowy opisuje [instrukcja wydania](release/README.md). Pliki w katalogu wersji są wynikiem kompilacji i nie podlegają ręcznej korekcie.
