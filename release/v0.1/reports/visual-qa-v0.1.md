...
| Element | Wartość |
|---|---|
| Katalog artefaktów | [dist/index.html](../index.html) |
| Wynik bramki generatora | [output-qa.json](../output-qa.json): `passed`, 17 artefaktów, 0 błędów |
...
|---|---|---|---|
| Strategia | [HTML](../strategy/index.html) · [PDF, 37 s.](../strategy/strategy.pdf) · [DOCX](../strategy/strategy.docx) | okładka, diagram cyklu, 2/2 alty DOCX, strona końcowa | **PASS** |
| Plan realizacji | [HTML](../implementation-roadmap/index.html) · [PDF, 21 s.](../implementation-roadmap/implementation-roadmap.pdf) · [DOCX](../implementation-roadmap/implementation-roadmap.docx) | RACI s. 15–16, końcówka s. 20–21, 1/1 alt DOCX | **PASS** |
| Finansowanie i wpływ | [HTML](../impact-finance/index.html) · [PDF, 22 s.](../impact-finance/impact-finance.pdf) · [DOCX](../impact-finance/impact-finance.docx) | szerokie tabele, marginesy, strona końcowa | **PASS** |
| Governance i prawo | [HTML](../governance-law/index.html) · [PDF, 20 s.](../governance-law/governance-law.pdf) · [DOCX](../governance-law/governance-law.docx) | dwustronicowa tabela RACI s. 8–9 i ostatnia strona | **PASS** |
| Księga dowodowa | [HTML](../evidence-book/index.html) · [PDF, 123 s.](../evidence-book/evidence-book.pdf) · [DOCX](../evidence-book/evidence-book.docx) | wszystkie strony rejestrów i wielostronicowych tabel | **PASS** |
| Jawny szablon aneksu ograniczonego | [HTML](../restricted-annex-template/index.html) · [PDF, 14 s.](../restricted-annex-template/restricted-annex-template.pdf) · [DOCX](../restricted-annex-template/restricted-annex-template.docx) | tabele, workflow i końcowe zastrzeżenia | **PASS** |
| Nota dla Premiera i RM | [HTML](../prime-minister-brief/index.html) · [PDF, 7 s.](../prime-minister-brief/prime-minister-brief.pdf) · [DOCX](../prime-minister-brief/prime-minister-brief.docx) | warianty, ryzyka i strona końcowa | **PASS** |
| Nota dla Prezydenta i BBN | [HTML](../president-bbn-brief/index.html) · [PDF, 8 s.](../president-bbn-brief/president-bbn-brief.pdf) · [DOCX](../president-bbn-brief/president-bbn-brief.docx) | tabela doktrynalna, ryzyka i zastrzeżenia | **PASS** |
| Briefy ministerialne | [HTML](../ministerial-briefs/index.html) · [PDF, 14 s.](../ministerial-briefs/ministerial-briefs.pdf) · [DOCX](../ministerial-briefs/ministerial-briefs.docx) | macierz zależności s. 12–13 | **PASS** |
| Brief międzynarodowy | [HTML](../international-brief/index.html) · [PDF, 6 s.](../international-brief/international-brief.pdf) · [DOCX](../international-brief/international-brief.docx) | język angielski, disclaimery i strona końcowa | **PASS** |
| Karta regionalnego pilotażu | [HTML](../regional-pilot-card/index.html) · [PDF, 28 s.](../regional-pilot-card/regional-pilot-card.pdf) · [DOCX](../regional-pilot-card/regional-pilot-card.docx) | s. 27–28; sekcja 16.4, tabela działań i miejsce na notatki | **PASS** |
| Karta danych województwa | [HTML](../voivodeship-data-template/index.html) · [PDF, 34 s.](../voivodeship-data-template/voivodeship-data-template.pdf) · [DOCX](../voivodeship-data-template/voivodeship-data-template.docx) | wszystkie 53 tabele i końcowy rejestr decyzji | **PASS** |
| Prezentacja dla RM | [HTML](../cabinet-deck/index.html) · [PDF, 15 slajdów](../cabinet-deck/cabinet-deck.pdf) · [PPTX](../cabinet-deck/cabinet-deck.pptx) | 2/2 diagramy z semantycznym altem | **PASS** |
| Prezentacja dla Prezydenta | [HTML](../president-deck/index.html) · [PDF, 12 slajdów](../president-deck/president-deck.pdf) · [PPTX](../president-deck/president-deck.pptx) | 1/1 diagram z semantycznym altem | **PASS** |
| Prezentacja na forum ekonomiczne | [HTML](../economic-forum-deck/index.html) · [PDF, 17 slajdów](../economic-forum-deck/economic-forum-deck.pdf) · [PPTX](../economic-forum-deck/economic-forum-deck.pptx) | 1/1 diagram z semantycznym altem | **PASS** |
| Prezentacja regionalna | [HTML](../regional-deck/index.html) · [PDF, 13 slajdów](../regional-deck/regional-deck.pdf) · [PPTX](../regional-deck/regional-deck.pptx) | wszystkie slajdy, tytuły i stały disclaimer | **PASS** |
| Prezentacja międzynarodowa | [HTML](../international-deck/index.html) · [PDF, 12 slajdów](../international-deck/international-deck.pdf) · [PPTX](../international-deck/international-deck.pptx) | angielski diagram na slajdzie 4; 1/1 angielski alt | **PASS** |

Model pomocniczy [financing-scenarios.xlsx](../models/financing-scenarios.xlsx) również przechodzi kontrolę. Zawiera osiem widocznych, niepustych arkuszy (`README`, `Assumptions`, `Commitments`, `Cost model`, `Funding map`, `Impact logic`, `Sensitivity`, `KPI`), 33 formuły i trzy walidacje danych. Nie ma błędów `#REF!`, komórek błędu ani odwołań do zewnętrznych skoroszytów. Wszystkie 33 wartości cache pozostają `UNKNOWN` zgodnie z zasadą fail-closed, a `fullCalcOnLoad=true` wymusza przeliczenie w zgodnym arkuszu kalkulacyjnym.
